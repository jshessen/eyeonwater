...
def test_get_statistics_id() -> None:
    sid = get_entity_statistic_id("meter-001")
    assert sid == "sensor.water_meter_meter_001"
...
def test_convert_statistic_data_single() -> None:
    ...
    result = convert_statistic_data([dp], last_reading=0.0)
    assert len(result) == 1
...
def test_convert_statistic_data_multiple() -> None:
    ...
    result = convert_statistic_data(points, last_reading=0.0)
    assert len(result) == 3
